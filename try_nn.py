...
sigma = 0.0001 # среднеквадратическое отклонение шум
...
weight = tf.Variable(initial_value=0.0, dtype=tf.float32, name="a")
...
optimizer = tf.train.GradientDescentOptimizer(0.0001).minimize(loss) # метод оптимизации, о нём тоже ниже
